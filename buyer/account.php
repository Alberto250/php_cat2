...
<div class="d-inline-block col-sm-3 pl-2 card ml-2 shadow-lg" style="top: 0px">
	<h3>Buying-result (last one)</h3>	<hr class="text-success">
...
$ps = $connection->prepare($sql);
$ps->execute([':u_id'=>$_SESSION['user_id']]);
...
?>
	...
	<b>date (time):</b><?=$res->date." (".$res->time.")"?> <br>
	<b>Car-mark:</b><?=$res->cname?><br>
	<b>Color:</b><?=$res->color?><br>
	<b>cost/u:</b><?=$res->cost?>$<br>
	<b>Quantity:</b><?=$res->quantity?><br>
	<b>Total cost:</b><?=$res->cost*$res->quantity?> $<br>
